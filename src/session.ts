...
import { applyBoost, applyHit, boostEase, comboBonus, stepSpeed } from "./game/physics";
import {
  generateAhead,
  generateWorld,
  recycleBehind,
...
export class Session {
  ...
  private hazards(): void {
    ...
    for (const h of this.world.hazards) {
      ...
      if (!sameLane(this.player.lane, h.lane, h.kind === "vortex" ? FEEL.vortexLaneTol : FEEL.laneTol)) continue;
